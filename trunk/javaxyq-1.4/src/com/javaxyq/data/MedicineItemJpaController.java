...
import com.javaxyq.data.exceptions.NonexistentEntityException;
import com.javaxyq.data.exceptions.PreexistingEntityException;
 ...
 */
public class MedicineItemJpaController {
    ...
    public void create(MedicineItem medicineItem) throws PreexistingEntityException, Exception {
    ...
    public void edit(MedicineItem medicineItem) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
