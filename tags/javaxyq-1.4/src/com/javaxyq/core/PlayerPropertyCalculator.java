...
public class PlayerPropertyCalculator {
	...
	public static int calc_速度(PlayerVO attrs) {
		return (int) (attrs.体质*0.1 + attrs.耐力*0.1 + attrs.力量*0.1 + attrs.敏捷*0.7 + attrs.魔力*0);
	}

	public static int calc_灵力(PlayerVO attrs) {
		return (int) (attrs.体质*0.3 + attrs.魔力*0.7 + attrs.耐力*0.2 + attrs.力量*0.4 + attrs.敏捷*0);
	}
	...
	public static int calc_体力(PlayerVO attrs) {
		return attrs.level*10 + 50;
	}
	public static int calc_活力(PlayerVO attrs) {
		return attrs.level*10 + 50;
	}
	...
	public static int calc_命中(PlayerVO attrs) {
		if(inArray(人族,attrs.character)) {			
			...
			return (int) (attrs.力量*2.3+27);
		}else if(inArray(仙族,attrs.character)) {
			return (int) (attrs.力量*1.7+30);
		}
		return -1;
	}
	...
	public static int calc_伤害(PlayerVO attrs) {
		if(inArray(人族,attrs.character)) {			
			return (int) (attrs.力量*0.7+34) ;
		}else if(inArray(魔族,attrs.character)) {
			return (int) (attrs.力量*0.8+34) ;
		}else if(inArray(仙族,attrs.character)) {
			return (int) (attrs.力量*0.6+40) ;
		}
		return -1;		
	}
	...
	public static int calc_防御(PlayerVO attrs) {
		if(inArray(人族,attrs.character)) {			
			return (int) (attrs.耐力*1.5) ;
		}else if(inArray(魔族,attrs.character)) {
			return (int) (attrs.耐力*1.3) ;
		}else if(inArray(仙族,attrs.character)) {
			return (int) (attrs.耐力*1.6) ;
		}
		return -1;
	}
	...
	public static int calc_魔法(PlayerVO attrs) {
		if(inArray(人族,attrs.character)) {			
			...
			return (int) (attrs.魔力*2.5+80) ;
		}else if(inArray(仙族,attrs.character)) {
			return (int) (attrs.魔力*3.5+80) ;
		}
		return -1;
	}
	/**
